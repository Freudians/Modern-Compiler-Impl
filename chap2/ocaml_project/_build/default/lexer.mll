...
| "\"" {Buffer.clear string_buff; strings lexbuf; Tokens.string_ (Buffer.contents string_buff, Lexing.lexeme_start lexbuf, (Lexing.lexeme_start lexbuf) + (Buffer.length string_buff))}
